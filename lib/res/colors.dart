...
const colorPrimary = Color(0xFF0a58ca);
...
const colorPending = Color(0xFFFFA500);
const colorComplete = Color(0xFF008000);
const colorPurple = Color(0xFF800080);
const colorBlue = Color(0xFF0000ff);
const colorGray = Color(0xFF808080);
const colorBrown = Color(0xFFa52a2a);

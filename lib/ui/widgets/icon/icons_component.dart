...
Widget buildRowTextImageIcon(SvgPicture svgPicture, String label,
    {TextStyle? textStyle, MainAxisAlignment? mainAxisAlignment, VoidCallback? onPress, bool? isExpanded}) {
  return Row(
